...
final class Decent_Lightbox_Frontend {
	...
	public function register_assets(): void {
		...
		wp_set_script_translations( 'seowk-lightbox', 'seo-wunderkiste' );
	}
	...
	public function maybe_enqueue_assets(): void {
		...
		wp_localize_script(
			...
			'decentLightboxL10n',
			array(
				'close'    => __( 'Close lightbox', 'seo-wunderkiste' ),
				'previous' => __( 'Previous image', 'seo-wunderkiste' ),
				'next'     => __( 'Next image', 'seo-wunderkiste' ),
				'loading'  => __( 'Loading image…', 'seo-wunderkiste' ),
			)
		);
	}
